...
def patch_cron_template_for_backup_schedule(base: dict, cluster_name: str, schedule_profile: BackupSchedule) -> dict:
    ...
    if schedule_profile.backupProfile.successfulJobsHistoryLimit:
         new_object["spec"]["successfulJobsHistoryLimit"] = schedule_profile.backupProfile.successfulJobsHistoryLimit
